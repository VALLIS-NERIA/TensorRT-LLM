...
from .config_utils import (extract_mamba_kv_cache_params, is_hybrid_linear,
...
def _non_hybrid_kv_cache_manager_cls(kv_cache_config: KvCacheConfig):
    return (KVCacheManagerV2
            if kv_cache_config.use_kv_cache_manager_v2 else KVCacheManager)
